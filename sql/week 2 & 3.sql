...
use assingment1;
create table CUSTOMER (CUSTNO varchar(20) primary key,
...
create table EVENTPLANLINE (PLANNO varchar(20) ,
foreign key(PLANNO) references EVENTPLAN(PLANNO),
LINENO INT primary key not null,
...
create table EVENTREQUEST (EVENTNO varchar(20) primary key,
DATEHELD varchar(50) not null,
DATEREQ varchar(50) not null,
CUSTNO varchar(50) not null,
foreign key(CUSTNO) references CUSTOMER(CUSTNO),
FACNO varchar(50) not null,
foreign key(FACNO) references FACILITY(FACNO),
DATEAUTH varchar(20) not null,
STATUS varchar(50) not null,
ESTCOST INT not null,
ESTAUDIENCE int not null,
BUNDNO VARCHAR(20) not null);

create table EVENTPLAN (PLANNO varchar(20) primary key,
EVENTNO varchar(50) not null,
...
modify NOTES varchar(200);

ALTER TABLE EVENTPLAN 
modify EMPNO varchar(200);

create table EMPLOYEE (EMPNO varchar(20) primary key,
...
modify DATEAUTH VARCHAR(20);

ALTER TABLE EVENTREQUEST
modify BUDNO VARCHAR(20);

ALTER TABLE EVENTREQUEST CHANGE BUNDNO BUDNO VARCHAR(20);


create table Facility (facno varchar(20) primary key,
facname varchar(50) not null);

create table Location (locno varchar(20) primary key,
facno varchar(10),
foreign key(facno) references Facility(facno),
locname varchar(50) not null
);
create table RESOURCETBL (RESNO varchar(20) primary key,
RESNAME varchar(10),
